...
3. This is an install-free build, not a fully self-contained "green" build. Settings, hosts, history, and logs are stored in:
   %LOCALAPPDATA%\codex\ssh-port-forwarder\data
...
5. portable.flag identifies this archive for future portable-specific behavior; do not delete it.
...
5. portable.flag 用于标识免安装包并为后续免安装专用行为预留，请勿删除。
