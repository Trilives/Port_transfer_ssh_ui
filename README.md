...
Download `v0.3.0-beta.4` from GitHub Releases:

- Recommended installer: `SSHDeck_0.3.0-beta.4_x64-setup.exe`
- Install-free ZIP: `SSHDeck_0.3.0-beta.4_x64-portable.zip` — extract it, then run `SSHDeck.exe` directly.
