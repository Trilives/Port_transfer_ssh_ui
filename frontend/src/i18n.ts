...
const text = {
  "zh-CN": {
    ...
    pinnedHosts: "置顶主机",
    pinnedHostsDesc: "已置顶的主机快捷入口，点击图标打开「远程连接」，用终端或 VS Code 打开历史路径。",
    keyEvents: "关键事件",
    ...
    // Config page
    configTitle: "端口转发管理",
    configDesc: "按主机管理 Local、Remote 与 Dynamic 端口转发；展开主机即可查看和操作其转发。",
    remoteConnectionsTitle: "远程连接",
    remoteConnectionsDesc: "按主机查看历史远端路径，并用终端或 VS Code 重新打开。",
    remotePathsCount: "条路径",
    refreshHistory: "刷新历史",
    loading: "加载中",
    loadingHistory: "正在加载远程连接历史…",
    newHost: "新建主机",
    editHost: "编辑主机",
    deleteHost: "删除主机",
    pin: "置顶",
    ...
    noForwardingHosts: "还没有主机。请先在「远程连接」页面新建或导入主机。",
    ...
    run: "执行",
    commandRunning: "正在后台执行…你可以关闭此窗口并继续使用其他功能。",
    ...
    historyTitle: "远程连接",
    historyDesc: "该主机的远端路径历史（来自 VS Code Remote-SSH，按 IP 匹配）。点击记录用终端打开，或用右侧按钮在 VS Code 中打开。",
    historyEmpty: "暂无历史路径。可在下方手动输入远端目录，用终端或 VS Code 打开。",
    remoteOpenPathLabel: "手动打开目录",
    remoteOpenPathPlaceholder: "远端目录，如 /home/user/project（留空则用终端进入家目录 / VS Code 直连）",
    remoteOpenTerminal: "终端",
    remoteOpenVscode: "VS Code",
  ...
  "en-US": {
    ...
    pinnedHostsDesc: "Quick access to pinned hosts — click the icon for Remote Connection to open a recent path in a terminal or VS Code.",
    ...
    configTitle: "Port Forwarding",
    configDesc: "Manage Local, Remote, and Dynamic forwards by host; expand a host to view and control its forwards.",
    remoteConnectionsTitle: "Remote Connections",
    remoteConnectionsDesc: "Browse remote path history by host and reopen a path in a terminal or VS Code.",
    remotePathsCount: "paths",
    refreshHistory: "Refresh history",
    loading: "Loading",
    loadingHistory: "Loading remote connection history…",
    newHost: "New Host",
    editHost: "Edit Host",
    ...
    noForwardingHosts: "No hosts yet. Create or import one from Remote Connections first.",
    ...
    run: "Run",
    commandRunning: "Running in the background… You can close this window and continue using the app.",
    ...
    // Remote connection (terminal / VS Code, by remote path)
    historyTitle: "Remote Connection",
    historyDesc: "Remote path history for this host (from VS Code Remote-SSH, matched by IP). Click a record to open a terminal there, or use the button to open it in VS Code.",
    historyEmpty: "No path history yet. Enter a remote directory below to open it in a terminal or VS Code.",
    remoteOpenPathLabel: "Open a directory manually",
    remoteOpenPathPlaceholder: "Remote path, e.g. /home/user/project (empty = terminal home / VS Code direct connect)",
    remoteOpenTerminal: "Terminal",
    remoteOpenVscode: "VS Code",
    historyKind_vscode: "VS Code",
