...
![Config page screenshot](docs/screenshot-config.png)
...
- Architecture, data model, and module layout: see [ARCHITECTURE.md](ARCHITECTURE.md).
- Dev environment, build, and release notes: see [TECHNICAL.md](TECHNICAL.md).
